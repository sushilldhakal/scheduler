...
The scheduler ships with 7 preset configurations. Using a preset sets sensible defaults for labels, colours, and view options:
...
Available presets: `createRosterConfig`, `createTvConfig`, `createConferenceConfig`, `createFestivalConfig`, `createHealthcareConfig`, `createGanttConfig`, `createVenueConfig`.
