...
const config = createVenueConfig({ visibleFrom: 8, visibleTo: 24, snapMinutes: 30 })
...
export default function VenueDemo() {
  ...
  return (
    <DemoShell title="Venue Bookings" description="Rooms, spaces, and client bookings" docsHref="/docs/examples/preset-venue">
      {mounted ? (
