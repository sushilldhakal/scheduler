...
export function ViewTabs({ view, setView }: ViewTabsProps): JSX.Element {
  ...
  return (
    <div className="flex items-center gap-2">
      {/* Period tabs — active tab shows full label, inactive shows first letter */}
      ...
      <ToggleGroup
        ...
        className="h-8"
      >
        <ToggleGroupItem value="list" className="h-6 w-6 p-0"><IList size={14} /></ToggleGroupItem>
        <ToggleGroupItem value="grid" className="h-6 w-6 p-0"><IGrid size={14} /></ToggleGroupItem>
      </ToggleGroup>
    </div>
  )
}