  ...
  return (
    ...
    >
      {grouped.map(({ date, shifts: ds_ }) => {
        ...
        const handleShiftClick = (shift: Shift, category: Category): void => {
          ...
          <div key={date.toDateString()}>
            <div
              ...
              style={{
                ...
                background: isOT ? "#eff6ff" : "#f8fafc",
                borderBottom: "1px solid #e5e7eb",
                position: "sticky",
                top: 0,
                zIndex: 5,
                outline: isOT ? "2px solid #3b82f6" : "none",
                outlineOffset: -2,
              }}
            >
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <div
                  style={{
                    ...
                    height: 36,
                    borderRadius: "50%",
                    background: isToday(date) ? "#3b82f6" : "#e5e7eb",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    flexShrink: 0,
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      fontSize: 11,
                      fontWeight: 600,
                      color: isDraft ? "#22c55e" : "#9ca3af",
                      background: isDraft ? "#dcfce7" : "#f3f4f6",
                      borderRadius: 6,
                      padding: "4px 10px",
                      flexShrink: 0,
                      cursor: "pointer",
